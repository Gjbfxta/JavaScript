...
los tipos de datos se dividen en primitivos y complejos.
   ...
   1. Tipos de datos primitivos
    ...
    Tambien hay valores boolianos que son los de verdadero o falso se utilizan para los condicionantes ademas Existen las cadenas de caracteres con el formato String y se usa para representar tecto se usa con comillas dobles o simples mientras que seas consistente con el uso de ese signo ("") o '' Puedes tener variables definidas cuando son inicializadas o indefinidas cuando no han sido inicializadas Array o arreglos son un conjunto de datos que los almacena en una lista ordenada de elementos. Los datos dentro de los arreglos se escriben entre corchetes. [] y separados por comas ,
